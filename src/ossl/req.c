	...
	char* outfile)
{
	...
	char* keyfile = NULL, *inrand = NULL;
	char *keyalgstr = NULL, *p, *passargin = NULL, *passargout = NULL;
	char *passin = NULL, *passout = NULL;
	char *nofree_passin = NULL, *nofree_passout = NULL;
	char *req_exts = NULL;
	//char *sTemplate = default_config_file;

	int ret = 1, x509 = 0, days = 30, i = 0, verbose = 0;
	int pkey_type = -1, private = 0;
	int outformat = FORMAT_PEM, keyform = FORMAT_PEM;
	int modulus = 0, multirdn = 0, verify = 0, noout = 0, text = 0;
	int newhdr = 0, subject = 0, pubkey = 0;
	long newkey = -1;
	...
	req_conf = app_load_config(sTemplate);
	if (sTemplate != default_config_file && !app_load_modules(req_conf))
		goto end;
