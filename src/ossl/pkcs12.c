...
int pkcs12_export(
		...
		char* passout)
{
	const int export_cert = 1;
    char *name = NULL, *csp_name = NULL;
    char pass[2048] = "", macpass[2048] = "";
	int options = 0, chain = 0, twopass = 0, keytype = 0;
...
# endif
    ...
    int noprompt = 0;
	char *passinarg = NULL, *passarg = NULL;
	char *passoutarg = NULL;
	char *passin = NULL, *inrand = NULL, *macalg = NULL;
	...
	/* direct in-process call, no need to use env
