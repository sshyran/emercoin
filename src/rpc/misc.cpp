...
static UniValue verifymessage(const JSONRPCRequest& request)
{
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The emercoin address to use for the signature."},
...
UniValue sendalert(const JSONRPCRequest& request)
{
    ...
    std::vector<unsigned char> vchPrivKey = ParseHex(request.params[1].get_str());
