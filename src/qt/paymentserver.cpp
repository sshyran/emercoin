...
PaymentServer::PaymentServer(QObject* parent, WalletController* wallet_controller, bool startLocalServer) :
    QObject(parent),
    saveURIs(true),
    uriServer(nullptr),
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("emercoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'emercoin://' is not a valid URI. Use 'emercoin:' instead."),
